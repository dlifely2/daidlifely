    ...
    handler: () => {
      window.location.href = "/al-folio/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-we-re-so-back-new-website-started-to-be-built-️",
          title: 'We’re so back! New website started to be built ⛏️',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%64%6C%69%66%65%6C%79@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-instagram',
        title: 'Instagram',
        section: 'Socials',
        handler: () => {
          window.open("https://instagram.com/davidlifely", "_blank");
        },
      },{
